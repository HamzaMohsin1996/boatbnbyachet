          ...
          <div className="banner-wrapper" style={{backgroundImage: `url('${bannerimg}')`}}>
            <div className="container">
                ...
                <div className="custom-tabs-wrapper">
                    <div className="nav nav-pills custom-tabs-btns" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="underline-link-blk small-text active" id="v-pills-home-tab" data-bs-toggle="pill"
                    ...
                    <button className="underline-link-blk small-text" id="v-pills-profile-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile"
                        aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="34.924" height="19.342" viewBox="0 0 34.924 19.342">
                    ...
                    <button className="underline-link-blk small-text" id="v-pills-settings-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings"
                        aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18.888" height="17.723" viewBox="0 0 18.888 17.723">
                    ...
                    <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                        ...
                        <div className="text-center check-img">
                        <p className="mb-4">Filters will be added by angular component.</p>
                        </div>
                        <div className="custom-flex"><a href="" className="custom-btn blue big-btn">Search</a></div>
                    </div>
